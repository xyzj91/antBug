...
typeof e?f+=b.toJsonStr(e):"number"==typeof e?f+=e:f=f+'"'+e.replace(/\n/g,"\\n")+'"',c.push(f))}return"{"+c.join(",")+"}"};b.converData=function(a){var c;try{c=toJsonStr(a)}catch(f){delete a.metaData;try{c=toJsonStr(a)}catch(h){return}}return c};b.isString=function(a){return"string"==typeof a&&a.constructor==String};b.dump=function(a,c){d.DEBUG&&(b.isString(a)||(a=JSON.stringify(a)),console.log(a),c&&console.log(c))};d.error=function(a){d.maxErrorNum&&(--d.maxErrorNum,a=b.converData(b.parseErrorMessage(a)),
    ...
    ":nth-child("+d+")")}a=a.parentNode}return b.join(" > ")};d.resourceErrorAdaper=function(a){if(d.collectResourceError&&!a.message){var c,f=(c=a.target?a.target:a.srcElement)&&c.outerHTML;f&&200<f.length&&(f=f.slice(0,200));var h={type:"resourceError",fileName:c.fileName,lineNumber:a.lineNumber,columnNumber:a.columnNumber,stacktrace:a.stacktrace,target:{outerHTML:f,src:c&&c.src,tagName:c&&c.tagName,id:c&&c.id,className:c&&c.className,name:c&&c.name,type:c&&c.type,XPath:b.parseUrl2Xpath(c),selector:b.parseSelector(c),
        timeStamp:a.timeStamp}};c.src===e.location.href||c.src&&c.src.match(/.*\/(.*)$/)&&!c.src.match(/.*\/(.*)$/)[1]||!h.target.src||!e.XMLHttpRequest||(a=new XMLHttpRequest,a.AntDebug=!0,a.open("HEAD",h.target.src),a.send(),a.onload=function(a){200!==a.target.status&&(h.target.status=a.target.status,h.target.statusText=a.target.statusText);d.error(h)})}};b.listenerError=function(){e.onerror=function(a,b,e,h,m){d.error({message:a,fileName:b,lineNumber:e,columnNumber:h,stacktrace:m})};n.onreadystatechange=
    function(){}};b.checkHttpStatus=function(a){return d.collectHttpError&&(1==a.detail.status||!/^file:\/\/\//.test(a.detail.url))&&2!==parseInt(a.detail.status/100)};d.resourceError=function(){e.addEventListener&&e.addEventListener("error",d.resourceErrorAdaper,!0);b._hashchange=e.onhashchange;e.onhashchange=function(){return b._hashchange.apply(this,arguments)};if(e.XMLHttpRequest&&(b.prototype=XMLHttpRequest.prototype,b.prototype)){var a,c,f,h=b.prototype.open;b.prototype.open=function(b,d){f=(new Date).getTime();
    a=b;c=d;try{h.apply(this,arguments)}catch(l){console.log("\u8bf7\u6c42\u5931\u8d25")}};var m=b.prototype.send;b.prototype.send=function(){var g=this,h=g.onreadystatechange;g.onreadystatechange=function(){if(4===g.readyState){var l=(new Date).getTime()-f,k={type:"XMLHttpRequest",page:{url:e.location.href},detail:{method:a,url:g.responseURL||c,status:g.status,statusText:g.statusText},elapsedTime:l,time:f};b.checkHttpStatus(k)&&d.error({type:"httpError",req:{method:k.detail.method,url:k.detail.url},
    res:{status:g.status,statusText:g.statusText,response:g.response,elapsedTime:l}})}h&&h.apply(this,arguments)};m.apply(this,arguments)}}};d.setExt=function(a){a&&(b.messageContent.ext=a)};d.init=function(a){if(b.isInit)return d;b.isInit=!0;d.resourceError();b.listenerError();a&&(b.messageContent=d.extend(b.messageContent,a))};return d}(window,document);
